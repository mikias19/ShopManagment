            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [
                  ...
                  Color.fromARGB(255, 252, 191, 125).withOpacity(0.9),
                ],
...
class _AuthCardState extends State<AuthCard>
  ...
  void showdialod(String message) {
    showDialog(
        context: context,
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      String errorMessage = 'Authentication failled!';
      ...
      if (error.toString().contains('EMAIL_EXISTS')) {
        ...
        errorMessage = "Invaid passwod";
      }

      showdialod(errorMessage);
    } catch (error) {
      const errorMessage =
